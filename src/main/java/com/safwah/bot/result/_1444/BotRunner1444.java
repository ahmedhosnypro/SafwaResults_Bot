...
public class BotRunner1444 {
    private static final Map<ResultBotExecutor1444, BotSession> sessions = new HashMap<>();

    public static void runBot(Bot bot) {
        ResultBotExecutor1444 resultBot = new ResultBotExecutor1444() {
            @Override
    ...
    static void onUpdate(ResultBotExecutor1444 executor, Update update) {
