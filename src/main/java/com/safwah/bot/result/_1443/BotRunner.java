...
public class BotRunner {
    private static final Map<ResultBotExecutor, BotSession> sessions = new HashMap<>();

    public static void runBot(Bot bot) {
        ResultBotExecutor resultBot = new ResultBotExecutor() {
            @Override
    ...
    static void onUpdate(ResultBotExecutor executor, Update update) {
