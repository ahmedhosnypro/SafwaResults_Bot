...
import static com.safwa.Main.EMAIL_PATTERN;
            ...
            if (messageText.equals("/start")) {
                ...
                sendMessage("""
                        ...
                        يمكنك البحث عن طريق الاسم أو البريد الالكتروني
                         ...
                         اذا بحثت بالاسم فتأكد من الهمزات (أءؤئ)

                         والياء (ي ى) والتاء المربوطة (ـه ـة)

                          بحيث يطابق الاسم الذي كتبته في استمارة الامتحان.

                         اذا بحثت بالبريد فتأكد من عدم وجود مسافات فارغة

                         أو ربما يكون الحرف الأول (كبير - capital)
                        ...
                        فربما يكون لانك امتحنتها ب(اسم/بريد) مختلف عن الذي أدخلته
                        لذلك حاول ببريد آخر أو تأكد من من أحرف الاسم الحساسة كالهمزات والياء   والتاء المربوطة
